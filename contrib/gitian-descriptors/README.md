...
--Updated 4/5/2014 by JebitcoinDevs--
--fixed QT source Links--
--Updated to Jebitcoin Folders--
--updated links to boost 1_55_0
--Added FAQ--



<img src="http://jebitcoin.com/splash.png" alt="Jebitcoin">
...
Once you've got the right hardware and software:
    ...
    https://github.com/JebitcoinCoin/jebitcoin.git
    ...
    cd ../gitian-builder
    git pull
    sudo ./bin/gbuild --commit Jebitcoin=HEAD ../Jebitcoin/contrib/gitian-descriptors/gitian.yml

    # Build Win32 dependencies: (only needs to be done once, or when dependency versions change)
    sudo ./bin/gbuild --commit Jebitcoin=HEAD ../Jebitcoin/contrib/gitian-descriptors/boost-win32.yml
    sudo ./bin/gbuild --commit Jebitcoin=HEAD ../Jebitcoin/contrib/gitian-descriptors/deps-win32.yml
    sudo ./bin/gbuild --commit Jebitcoin=HEAD ../Jebitcoin/contrib/gitian-descriptors/qt-win32.yml

    # Build Win32 release:
    sudo ./bin/gbuild --commit Jebitcoin=HEAD ../Jebitcoin/contrib/gitian-descriptors/gitian-win32.yml
...
If you need more help please visit Jebitcoin Forum at www.Jebitcoin.rocks
